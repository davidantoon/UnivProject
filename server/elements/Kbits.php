...
echo 'Kbits included successfuly <hr>';
...
class Kbit {
	...
	public static function get_kbit_by_UID($UID) {
		...
		return $results[0];
		// throw new Exception('Unimplemented method _get_kbit_by_UID_');
	}
